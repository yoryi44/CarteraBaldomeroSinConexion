...
public class MetodoDePagoTransferenciaUpdate {
     ...
     */
    public static void vistaDialogoUpdateTransferencia(final Context contexto, @NonNull String titulo, @NonNull String texto, View.OnClickListener onClickListenerAceptar,
        ...
        final TextView tvFechaFragEfec, tvDescripcionCheque, tvNumeroCheque, simboloTransf;
        final TextView tvNombreDepoTransferencia, tvNombreCuenta, tvCuentaOrigen, tvMonto;
        final Spinner spinnerCuentasBancoTransf;
        final EditText tvValorTransferencia;
        ...
        tvValorTransferencia = dialogo.findViewById(R.id.tvValorTransferencia);
...
//        tvNumeroCheque = dialogo.findViewById(R.id.tvNumeroCheque);
        spinnerCuentasBancoTransf = dialogo.findViewById(R.id.spinnerCuentasBancoTransf);
        tvMonto = dialogo.findViewById(R.id.tvMonto);
        guardarFormaPagoFE = dialogo.findViewById(R.id.guardarFormaPagoFE);
        guardarFormaPagoPendienteChe = dialogo.findViewById(R.id.guardarFormaPagoFE);
        ...
        if (anticipo != null) {
            if (anticipo.estado == true) {
                ...
                if(lienarChequeReferencia != null) lienarChequeReferencia.setVisibility(View.VISIBLE);
        ...
        tvNombreDepoTransferencia.setText("");
        ...
        tomarFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MetodoDePagoTransferenciaUpdate.dialogo.onSaveInstanceState();
        ...
        if (cargarFacturas.size() > 0) {
            for (Facturas facturas1 : cargarFacturas) {
                if (finalEmpresa.equals("AGCO") || finalEmpresa.equals("AGSC") || finalEmpresa.equals("AGGC") || finalEmpresa.equals("AFPN")
                    ...
                    NumberFormat formatoNumero = NumberFormat.getInstance(new Locale("es"));
                    tvValorTransferencia.setText(formatoNumero.format(valorSetText));
                ...
                tvNombreDepoTransferencia.setText(facturas1.getReferencia());
...
//                tvNumeroCheque.setText(facturas1.getNumeroCheque());
        ...
        guardarFormaPagoFE.setVisibility(View.VISIBLE);

        /// decimales .., else ... else ,,.  5
        tvValorTransferencia.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (finalEmpresa.equals("AGSC") || finalEmpresa.equals("AGGC") || finalEmpresa.equals("AFPN")
                    ...
                    if (!input.isEmpty()) {
                        ...
                        tvValorTransferencia.removeTextChangedListener(this); //To Prevent from Infinite Loop
                        tvValorTransferencia.setText(newPrice);
                        tvValorTransferencia.setSelection(newPrice.length()); //Move Cursor to end of String
                        tvValorTransferencia.addTextChangedListener(this);
                    ...
                    if (!input.isEmpty()) {
                        ...
                        if (input.length() < 3) {
                            ...
                            tvValorTransferencia.removeTextChangedListener(this); //To Prevent from Infinite Loop
                            tvValorTransferencia.setText(newPrice2);
                            tvValorTransferencia.setSelection(newPrice2.length()); //Move Cursor to end of String
                            tvValorTransferencia.addTextChangedListener(this);
        ...
        guardarFormaPagoPendienteChe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (facCollection != null) {
                    ...
                    referenciaCheq = tvNombreDepoTransferencia.getText().toString();
                    cuentaDestino = spinnerCuentasBancoTransf.getSelectedItem().toString();
//                    numCheque = tvNumeroCheque.getText().toString();
                    nombrePropietario = "";
                    input = tvValorTransferencia.getText().toString();
                        ...
                        if (facCollection != null) {
                            ...
                            try {
                                ...
                                if (DataBaseBO.updateFormaPago(finalIdsPagos, claseDocumento, sociedad,
                                    ...
                                    DataBaseBO.guardarFormaPago(idPago, claseDocumento,
                                            sociedad, cod_cliente, finalCod_Vendedor,
                                            referenciaCheq, fechasDocumentos.get(0),
                                            fecha, precios,
                                            moneda, preciosfacturasLogica, Double.parseDouble(preciosParcial.get(0)), cuentasBanco,
