...
public class MetodoDePagoBitcoinUpdate {
     ...
     */
    public static void vistaDialogoUpdateBitcoin(final Context contexto, @NonNull String titulo, @NonNull String texto, View.OnClickListener onClickListenerAceptar,
      ...
      //  listsaFacturasParcialTotal = DataBaseBO.cargarFacParTotal(nroReciboFacTotalPar, documentosFinanciero);
        ...
        tomarFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MetodoDePagoBitcoinUpdate.dialogo.onSaveInstanceState();
...
//Actualizada total 29 para update
...
/// fac para anticipo 3
                ...
                if (spinnerCuentasBanco.getSelectedItem().toString().equals("Seleccione") || spinnerCuentasBanco.getSelectedItem().toString().equals("Select")) {
                    if (lenguajeElegido == null) {
                ...
                if (valor != 0 && !fecha.equals("")
                        && !spinnerCuentasBanco.getSelectedItem().toString().equals("Seleccione") || !spinnerCuentasBanco.getSelectedItem().toString().equals("Select")) {
                    ...
                    if (facCollection == null) {
                        ...
                        if (anticipo.estado == true) {
                            ...
                            if (DataBaseBO.updateFormaPagoParcial(finalIdsPagos, claseDocumento, sociedad,
                                    cod_cliente, finalCod_Vendedor, "0", fecha_Consignacion,
                                    fecha, precios,
                                    moneda, precios,
                                    precios,
                                    spinnerCuentasBanco.getSelectedItem().toString(), moneda_Consig,
                        ...
                        try {
                            if (formaPago.parcial == true) {
                                ...
                                if (DataBaseBO.updateFormaPago(finalIdsPagos, claseDocumento, sociedad,
                                        cod_cliente, finalCod_Vendedor, "0", fechasDocumentos,
                                        fecha, precios,
