...
public class MetodoDePagoEfectivoUpdate {
     ...
     */
    public static void vistaDialogoUpdateEfectivo(final Context contexto, @NonNull String titulo, @NonNull String texto, View.OnClickListener onClickListenerAceptar,
                                                  View.OnClickListener onClickListenerCancelar) {

        final TextView tvFechaFragEfec, simboloefec, tvDescripcionFragEfec, tvMonto, tvReferenciaEfectivo, tvCuentaDestinoEfectivo;
        ...
        final List<Facturas> listaFacturasEfectivo;
        ...
        Gson gson3 = new Gson();
        String stringJsonObject3 = PreferencesFormaPago.obteneFacturaSeleccionada(contexto);
        formaPago = gson3.fromJson(stringJsonObject3, FormaPago.class);

        Gson gson4 = new Gson();
        String stringJsonObject4 = PreferencesAnticipo.obteneAnticipoSeleccionada(contexto);
        anticipo = gson4.fromJson(stringJsonObject4, Anticipo.class);
        ...
        final List<String> idesPagoEfectivo = new ArrayList<>();
        ...
        final List<String> valoresfacturasCheq = new ArrayList<>();
...
///se saca el valor
        ...
        listaFacturasEfectivo = Utilidades.listaFacturasMetodofectivo(contexto, idesPago);
        ...
        valorConsignadoEfectivo = Utilidades.CountMetodoPagoEfec(contexto);
        ...
        //      valorConsignadoE = Utilidades.totalFormasPagoEfecCantidadFacturas(contexto, idesPago);
        ...
        final String finalDocumentoFinanciero1 = documentoFinanciero;
        ...
        tomarFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MetodoDePagoEfectivoUpdate.dialogo.onSaveInstanceState();
        ...
        if (cargarFacturas.size() > 0) {
            for (Facturas facturas1 : cargarFacturas) {
                ...
                tvReferenciaEfectivo.setText(facturas1.getReferencia());
        ...
        double finalValorConsignadoE = valorConsignadoE;
        double finalValorConsignadoEfectivo = valorConsignadoEfectivo;
        ...
        guardarFormaPagoPendienteEfec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String fotoID = "";
                double valor = 0;
                double valorEfec = finalValorConsignadoE;
                ...
                if (facCollection != null) {
                    if (valor != 0 && !fecha.equals("") && !descripcion.equals("")) {
                        ...
                        if (facCollection != null) {
                            ...
                            if (fotos == null) {
                                fotoID = DataBaseBO.cargarFotosSinDocumentosAsociados(documentosFinanciero.get(0), contexto);
                            }
                            if (fotos != null) {
                            ...
                            try {
                                ...
                                if (DataBaseBO.updateFormaPagoPendientes(finalIdsPagos, claseDocumento, sociedad, cod_cliente, finalCod_Vendedor
                                        ...
                                        descripcion, via_Pago, usuario, operacion_Cme, sincronizado, spinBanco,
                                        "0", "0", fotoID, finalConsecutivoid, contexto)) {


                                    DataBaseBO.eliminarRecaudosPendientes(finalIdsPagos, contexto);
                                    ...
                                    if (finalValorConsignadoEfectivo >= 2) {
                                        ...
                                        double valorComEfectivo = 0;
                                        String idPagoEfectivo = "";
                                        String referenciaEfectivo = "";

                                        listaFacHchasUnaPorUna.add(idPago);
                                        listsaFacturasParcialTotalEfectivo = Utilidades.listaFacturasParcialTotalEfectivoCantidadFac(contexto, idesPago);
                                        listsaIDEfectivo = Utilidades.listaFacturasIDEfectivo(contexto);

                                        for (Facturas facturasids : listaFacturasEfectivo) {
                                            idPagoEfectivo = facturasids.getIdPago();
                                            if (finalIdsPagos1 != idPagoEfectivo) {
                                                idesPagoEfectivo.add(idPagoEfectivo);
                                                referenciaEfectivo = facturasids.referencia;

                                            }
                                        }

                                        for (Facturas fac : listsaFacturasParcialTotalEfectivo) {
                                            valorComEfectivo = fac.valor;
                                            valoresfacturasEfectivo.add(String.valueOf(Utilidades.formatearDecimales(valorComEfectivo, 2)));

                                        }

                                        for (int k = 0; k < idesPagoEfectivo.size(); k++) {

                                            double valorPorid = Utilidades.totalFormasPagoEfecCantidadFacturasHechas(contexto, idesPagoEfectivo.get(k), listaFacHchasUnaPorUna);
                                            inputEfect = String.valueOf(valorPorid);
                                                            ...
                                                            for (int j = 0; j < preciosfacturasLogica.size(); j++) {
                                                                ...
                                                                if (valoresFacReales.size() > 0) {
                                                                    ...
                                                                    if (valorvaloresFacReales > valorLista2) {
                                                                        totalFacturasEfectivo.clear();
                                                                        preciosParcialEfectivo.clear();
                                                                        preciosfacturasLogicaEfectivo.clear();
                                            ...
                                            DataBaseBO.eliminarRecaudosPendientes(idesPagoEfectivo.get(k), contexto);

                                            final String idEfectivoPago = finalCodigoVendedor + Utilidades.fechaActual("ddHHmmss") + k;

                                            listaFacHchasUnaPorUna.add(idEfectivoPago);
                                    ...
                                    if (finalCountCheque >= 1) {
                                        ...
                                        for (Facturas fac : listsaFacturasParcialTotalCheq) {
                                            valorCom = fac.valor;
                                            valoresfacturasCheq.add(String.valueOf(Utilidades.formatearDecimales(valorCom, 2)));
                                        ...
                                        inputCheq = String.valueOf(valorCheq);
                                                ...
                                                for (int i = 0; i < precios.size(); i++) {
                                                    ...
                                                    if (i == 0) {
                                                        ...
                                                        for (int j = 0; j < preciosfacturasLogica.size(); j++) {
                                                            ...
                                                            if (finalValorConsignadoEfectivo >= 2) {
                                                                valorLista = Double.parseDouble(preciosfacturasLogicaEfectivo.get(j));
                                                            }
                                        ...
                                        DataBaseBO.guardarFormaPagParcialPendiente(idChequePago, claseDocumento,
                                                ...
                                                fecha, precios,
                                                moneda, preciosfacturasLogicaCheq, preciosParcialCheq, 0, cuentaBancaria,
                                                moneda_Consig, NCF_Comprobante_fiscal, documentosFinanciero,
                                                consecutivo1,
                                                descripcion, "B", usuario, operacion_Cme,
                                                sincronizado, banco, numeroCheque,
                                    ...
                                    /**  DataBaseBO.updateFormaPagoPendientesCheque(idPagoCheque, claseDocumento, sociedad, cod_cliente, cod_Vendedor
                                     , referenciaCheque, fechasDocumentos,
                                     fecha, precios,
                                     moneda, preciosfacturasLogicaCheq, preciosParcialCheq, cuentasBanco,
                                     moneda_Consig, NCF_Comprobante_fiscal, documentosFinanciero, consecutivo1,
                                     descripcion, "B", usuario, operacion_Cme, sincronizado, spinBanco,
                                     numeroCheque, "0", fotoID); **/
                                        ...
                                        if (listsaFacturasParcialTotal.size() > 0) {
                                            try {
                                                ...
                                                for (int i = 0; i < precios.size(); i++) {
                                                    ...
                                                    if (i == 0) {
                                                        if (listsaFacturasParcialTotal.size() > 0) {
                                                            if (preciosfacturasLogicaCheq.size() > 0) {
                                                                for (int j = 0; j < preciosfacturasLogicaCheq.size(); j++) {
                                                        ...
                                                        for (int j = 0; j < preciosfacturasLogicaCheq.size(); j++) {
                                                            ...
                                                            double valorLista2 = Double.parseDouble(preciosfacturasLogica.get(j));
                                                            double valorLista3 = Double.parseDouble(preciosfacturasLogicaCheq.get(j));
...
//                                                "0", fotoTrans, finalConsecutivoidTransferencia);
                                    ...
                                    if (finalCountTarjeta >= 1) {
                                        ...
                                        for (Facturas fac : listsaIDTarjeta) {
                                            ...
                                            nombrePropietario = fac.nombrePropietario;
                                        ...
                                        DataBaseBO.guardarFormaPagParcial(idTarjetaPago, claseDocumento, sociedad,
                                                ...
                                                "0", nombrePropietario, fotoTarjeta, finalConsecutivoidTarjeta, consecutivo2, formaPago != null ? formaPago.observacionesMotivo : "", contexto);
                    ...
                    if (valor != 0 && !fecha.equals("") && !descripcion.equals("")) {
                        ...
                        if (facCollection == null) {
                            ...
                            if (anticipo.estado == true) {
                                ...
                                if (DataBaseBO.updateFormaPagoParcialAnticPend(finalIdsPagos, claseDocumento, sociedad, cod_cliente, finalCod_Vendedor
                                        , referencia, fecha_Consignacion,
                                        fecha, preciosAnticipo,
                                        moneda, precios, precios, cuentasBanco,
                                        moneda_Consig, NCF_Comprobante_fiscal, finalDocumentoFinanciero, consecutivo1,
                                        descripcion, via_Pago, usuario, operacion_Cme, sincronizado, spinBanco,
                                        "0", "0", fotoID, finalConsecutivoid, contexto)) {
