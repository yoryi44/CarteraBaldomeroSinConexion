...
public class PreferencesCarteraFactura {

    public static final String FACTURASELECCIONADO = "FACTURASELECCIONADO";
    private static final String NOMBRE = "facturaseleccionado";
    private static final String ORDENFACTURAS = "ORDEN";
    private static final String ORDEN = "orden";
    private static final String LISTAORDENADAFACTURAS = "listaordenadafacturas";


    public static void guardarFacturaSeleccionada(Context context, String usuario) {

        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(FACTURASELECCIONADO, usuario);
        editor.commit();
    }
    ...
    public static String obteneFacturaSeleccionada(Context context) {
        ...
        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        return settings.getString(FACTURASELECCIONADO, "");
    }
     ...
     * @param context
     */
    public static void vaciarPreferencesFacturaSeleccionada(Context context) {
    ...
    public static void guardarOrdenFacturaSeleccionada(Context context, int orden) {
        ...
        SharedPreferences.Editor editor = settings.edit();
        editor.putInt(ORDENFACTURAS, orden);
        editor.apply();
    }
    ...
    public static int obtenerOrdenFacturaSeleccionada(Context context) {
        SharedPreferences settings = context.getSharedPreferences(ORDEN, Context.MODE_PRIVATE);
        return settings.getInt(ORDENFACTURAS, 0);
    }
    ...
    public static void guardarListaOrdenFacturaSeleccionada(Context context, ArrayList<String> listaOrden) {
        ...
        prefsEditor.putString(LISTAORDENADAFACTURAS, j);
        prefsEditor.apply();
    }
    ...
    public static ArrayList<String> loadListaFacturaSeleccionadaOrdenados(Context context) throws JSONException {
        ...
        //Obtiene datos (json)
        String objetos = prefs.getString(LISTAORDENADAFACTURAS, "");
