...
public class PreferencesFacRealizadasSeleccionadas {
    ...
    public static void guardarFacRealizadasSeleccionadas(Context context, String usuario) {
    ...
    public static String obtenerFacRealizadasSeleccionadas(Context context) {
     ...
     * @param context
     */
    public static void vaciarPreferencesFacRealizadasSeleccionadas(Context context) {
     ...
     */
    public static void guardarOrdenFacRealizadasSeleccionadas(Context context, int orden) {
     ...
     */
    public static int obtenerOrdenFacRealizadasSeleccionadas(Context context) {
        SharedPreferences settings = context.getSharedPreferences(ORDEN, Context.MODE_PRIVATE);
        return settings.getInt(ORDENFACPENDSELECC, 0);
    }

    public static void guardarListaOrdenFacRealizadasSeleccionadas(Context context, ArrayList<String> listaOrden) {
    ...
    public static ArrayList<String> loadListaFacturasFacRealizadasSeleccionadas(Context context) throws JSONException {
