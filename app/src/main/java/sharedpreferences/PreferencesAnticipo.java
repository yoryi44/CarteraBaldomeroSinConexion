...
public class PreferencesAnticipo {

        public static final String FORMAPAGOANTICIPO = "FORMAPAGOANTICIPO";
        private static final String NOMBRE = "anticipo";
        private static final String ORDENANTICIPO = "ORDEN";
        private static final String ORDEN = "orden";
        private static final String LISTAORDENADAANTICIPO = "listaordenadaanticipo";


        public static void guardarAnticipoSeleccionada(Context context, String usuario) {

        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(FORMAPAGOANTICIPO, usuario);
        editor.commit();
    }
        ...
        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        return settings.getString(FORMAPAGOANTICIPO, "");
    }
         ...
         * @param context
         */
        public static void vaciarPreferencesAnticipoSeleccionada(Context context) {
        ...
        SharedPreferences.Editor editor = settings.edit();
        editor.putInt(ORDENANTICIPO, orden);
        editor.apply();
    }
        ...
        SharedPreferences settings = context.getSharedPreferences(ORDEN, Context.MODE_PRIVATE);
        return settings.getInt(ORDENANTICIPO, 0);
    }
        ...
        prefsEditor.putString(LISTAORDENADAANTICIPO, j);
        prefsEditor.apply();
    }
        ...
        //Obtiene datos (json)
        String objetos = prefs.getString(LISTAORDENADAANTICIPO, "");
