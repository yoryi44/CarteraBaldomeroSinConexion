...
public class PreferencesCartera  {

    public static final String CARTERASELECCIONADA = "CARTERASELECCIONADA";
    private static final String NOMBRE = "carteraseleccionada";
    private static final String ORDENCARTERA = "ORDEN";
    private static final String ORDEN = "orden";
    private static final String LISTAORDENADACARTERA = "listaordencartera";


    public static void guardarCarteraSeleccionada(Context context, String usuario) {

        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(CARTERASELECCIONADA, usuario);
        editor.commit();
    }

    public static String obteneCarteraSeleccionada(Context context) {

        SharedPreferences settings = context.getSharedPreferences(NOMBRE, Context.MODE_PRIVATE);
        return settings.getString(CARTERASELECCIONADA, "");
    }
     ...
     * @param context
     */
    public static void vaciarPreferencesCarteraSeleccionada(Context context) {
    ...
    public static void guardarOrdenFacturaSeleccionada(Context context, int orden) {
        ...
        SharedPreferences.Editor editor = settings.edit();
        editor.putInt(ORDENCARTERA, orden);
        editor.apply();
    }
    ...
    public static int obtenerOrdenFacturaSeleccionada(Context context) {
        SharedPreferences settings = context.getSharedPreferences(ORDEN, Context.MODE_PRIVATE);
        return settings.getInt(ORDENCARTERA, 0);
    }
    ...
    public static void guardarListaOrdenFacturaSeleccionada(Context context, ArrayList<String> listaOrden) {
        ...
        prefsEditor.putString(LISTAORDENADACARTERA, j);
        prefsEditor.apply();
    }
    ...
    public static ArrayList<String> loadListaFacturaSeleccionadaOrdenados(Context context) throws JSONException {
        ...
        //Obtiene datos (json)
        String objetos = prefs.getString(LISTAORDENADACARTERA, "");
